...
const Pricing = () => {
  return (
    <section className="w-full sm:max-w-7xl mx-auto py-24 px-4 relative">
      ...
      <AnimationContainer delay={0.2} className="flex justify-center w-full">
        <div className="space-y-6 w-full md:w-[500px] relative p-8 transition-all duration-300 bg-background/30 hover:bg-white/5 backdrop-blur-sm shadow-lg hover:shadow-xl rounded-2xl border border-white/10">
          ...
          <Link
            href="/signup"
            className="w-full inline-flex items-center justify-center rounded-lg px-4 py-3 transition-all duration-300 bg-primary/10 hover:bg-primary/20 text-primary border border-primary/20 hover:border-primary/30"
          >
            Get Started
          </Link>
        </div>
